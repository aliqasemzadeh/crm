...
class Assign extends Component
{
    ...
    #[On('panels.workspace.dashboard.task.assign.assign-data')]
    public function assignData($id)
    {
        ...
        $this->search = '';
        Flux::modal('panels.workspace.dashboard.task.assign.modal')->show();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.panels.workspace.dashboard.task.assign', [
            'users' => $users,
