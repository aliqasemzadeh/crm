...
class UploadImage extends Component
{
    ...
    #[On('panels.warehouse.item.upload-image.assign-data')]
    public function assignData($id): void
    {
        ...
        $this->dispatch('modal-show', name: 'panels.warehouse.item.upload-image.modal');
    }
    ...
    public function store(): void
    {
        ...
        $this->photos = [];
        $this->dispatch('modal-close', name: 'panels.warehouse.item.upload-image.modal');
        ...
        $this->dispatch('panels.warehouse.item.upload-image.saved');
    }
    ...
    {
        return view('livewire.panels.warehouse.item.upload-image');
    }
}
