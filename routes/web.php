...
Route::middleware(['auth'])->group( function () {
    ...
    Route::livewire('/panels/sale/item-cluster/create', 'pages::panels.sale.item-cluster.create')->name('panels.sale.item-cluster.create');
    Route::livewire('/panels/sale/item-cluster/{cluster}/edit', 'pages::panels.sale.item-cluster.edit')->name('panels.sale.item-cluster.edit');
