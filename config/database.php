    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'mysrs_crm'),
        ...
        'voip' => [
            ...
            'username' => env('VOIP_DB_USERNAME', 'root'),
            'password' => env('VOIP_DB_PASSWORD', ''),
        ...
        'sqlsrv' => [
            ...
            'host' => env('SQLSRV_DB_HOST', '192.168.3.114'),
            'port' => env('SQLSRV_DB_PORT', '1433'),
            'database' => env('SQLSRV_DB_DATABASE', 'Sepidar01'),
            'username' => env('SQLSRV_DB_USERNAME', 'crm_user'),
            'password' => env('SQLSRV_DB_PASSWORD', 'StrongPassword@123'),
            'charset' => env('SQLSRV_DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'encrypt' => env('SQLSRV_DB_ENCRYPT', 'no'),
        ...
        'setaregan_sqlsrv' => [
            ...
            'host' => env('SETAREGAN_SQLSRV_DB_HOST', 'setaregan.co'),
            'port' => env('SETAREGAN_SQLSRV_DB_PORT', '9992'),
            'database' => env('SETAREGAN_SQLSRV_DB_DATABASE', 'setaregan_db'),
            'username' => env('SETAREGAN_SQLSRV_DB_USERNAME', 'strgn_usr'),
            'password' => env('SETAREGAN_SQLSRV_DB_PASSWORD', 'xasndge2qlyiwoktcjfu'),
