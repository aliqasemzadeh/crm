...
new class extends Component
{
    ...
    public function assignData(int $id): void
    {
        ...
        $this->form->sms_text = $rule->sms_text ?: __('app.cash_back_sms');
        $this->form->site_url = $rule->site_url ?: 'https://setaregan.co';
        $this->test_mobile = '';
...
<flux:modal name="panels.crm.cash-back-rule.edit.modal" flyout position="right" class="md:w-[28rem]">
    <div class="space-y-6">
