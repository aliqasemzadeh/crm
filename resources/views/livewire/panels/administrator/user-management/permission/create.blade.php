<flux:modal name="panels.administrator.user-management.permission.create.modal" class="md:w-96">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.create_permission') }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.create_permission_description') }}</flux:text>
        </div>
