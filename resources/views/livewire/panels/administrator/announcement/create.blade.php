<flux:modal name="panels.administrator.announcement.create.modal" class="md:min-w-[600px]">
    <form wire:submit="create" class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.create_announcement') }}</flux:heading>
            <flux:subheading>{{ __('app.create_announcement_description') }}</flux:subheading>
        </div>
        ...
        <div class="flex">
            ...
            <flux:button type="submit" variant="primary" class="ms-3">{{ __('app.create') }}</flux:button>
        </div>
    </form>
</flux:modal>
