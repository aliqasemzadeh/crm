...
<div>
    ...
    <div class="space-y-6 mb-10">
        ...
        <flux:card class="bg-zinc-50 dark:bg-zinc-900 border-t-4 border-zinc-500">
            <div class="flex justify-between items-center">
                <flux:heading size="lg">{{ __('app.total_annual_receipt_cheques') }}</flux:heading>
    ...
    <div class="mb-6">
        <flux:field>
            ...
            <flux:input wire:model.live.debounce.500ms="search" type="text" placeholder="{{ __('app.search_in_receipt_cheques') }}" />
        </flux:field>
    </div>
            ...
            <flux:table.row :key="$cheque->ReceiptChequeId">
                <flux:table.cell class="w-1 whitespace-nowrap">
                    <div class="flex items-center gap-2">
                        <flux:button size="xs" variant="primary" color="sky" wire:click="$dispatch('panels.accounting.receipt-cheque.view.assign-data', { id: '{{ $cheque->ReceiptChequeId }}' })">{{ __('app.view') }}</flux:button>
                    </div>
                </flux:table.cell>
