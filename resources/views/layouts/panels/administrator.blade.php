...
<flux:sidebar sticky collapsible="mobile" class="panel-shell-sidebar dark:bg-zinc-900 dark:border-zinc-700">
    ...
    <flux:sidebar.nav>
        ...
        <flux:sidebar.group expandable heading="{{ __('app.user_management') }}" class="grid" :expanded="request()->routeIs('panels.administrator.user-management.*')">
            ...
            <flux:sidebar.item href="{{ route('panels.administrator.user-management.record.index') }}" wire:navigate>{{ __('app.attendance_records') }}</flux:sidebar.item>
            <flux:sidebar.item href="{{ route('panels.administrator.user-management.days.index') }}" wire:navigate>{{ __('app.hr_day_records_manage') }}</flux:sidebar.item>
